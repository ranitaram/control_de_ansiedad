import 'package:control_de_ansiedad/screens/acuerdate/acuerdate_25.dart';
import 'package:control_de_ansiedad/widgets/boton_ejercicio.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

class Desafio25Page extends StatelessWidget {
  @override
        ...
        floatingActionButton: FloatingActionButton.extended(
          ...
          onPressed: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => Acuerdate25Page()));
          },
          icon: const FaIcon(
            Icons.chevron_right,
            color: Colors.white,
