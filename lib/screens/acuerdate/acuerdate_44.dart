import 'package:control_de_ansiedad/screens/descubrimientos/que_aprendimos44.dart';
import 'package:control_de_ansiedad/widgets/boton_ejercicio.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

class Acuerdate44Page extends StatelessWidget {
  @override
              ...
              child: PageView(
                ...
                children: [
                  BotonEjercicio(
                      ...
                      texto:
                          'Coloca notas que digan “Registra la impaciencia” en tu ambiente, en especial, en los lugares donde sabes que es probable que surja la impaciencia.',
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => QueAprendimos44Page()));
                },
                child: Container(
                  width: 50,
                  height: 30,
