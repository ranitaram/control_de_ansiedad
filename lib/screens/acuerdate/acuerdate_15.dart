import 'package:control_de_ansiedad/screens/descubrimientos/que_aprendimos15.dart';
import 'package:control_de_ansiedad/widgets/boton_ejercicio.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

class Acuerdate15Page extends StatelessWidget {
  @override
              ...
              child: PageView(
                ...
                children: [
                  BotonEjercicio(
                      ...
                      texto:
                          'Coloca un cuaderno en tu mesa o escritorio y úsalo para hacer todas las noches un plan sobre cuál será tu acto secreto de virtud el próximo día',
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => QueAprendimos15Page()));
                },
                child: Container(
                  width: 50,
                  height: 30,
