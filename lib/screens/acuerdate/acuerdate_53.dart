import 'package:control_de_ansiedad/screens/descubrimientos/que_aprendimos53.dart';
import 'package:control_de_ansiedad/widgets/boton_ejercicio.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

class Acuerdate53Page extends StatelessWidget {
  @override
              ...
              child: PageView(
                ...
                children: [
                  BotonEjercicio(
                      ...
                      texto:
                          'Coloca las palabras “Mejor que como lo encontraste” en lugares adecuados, como la cocina, el baño, el dormitorio y la puerta de salida de estos lugares.',
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => QueAprendimos53Page()));
                },
                child: Container(
                  width: 50,
                  height: 30,
