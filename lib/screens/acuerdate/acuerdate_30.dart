import 'package:control_de_ansiedad/screens/descubrimientos/que_aprendimos30.dart';
import 'package:control_de_ansiedad/widgets/boton_ejercicio.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

class Acuerdate30Page extends StatelessWidget {
  @override
              ...
              child: PageView(
                ...
                children: [
                  BotonEjercicio(
                      ...
                      texto:
                          'Coloca notas que digan “¿Definiendo y defendiendo?” en lugares adecuados.',
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => QueAprendimos30Page()));
                },
                child: Container(
                  width: 50,
                  height: 30,
