import 'package:control_de_ansiedad/screens/descubrimientos/que_aprendimos41.dart';
import 'package:control_de_ansiedad/widgets/boton_ejercicio.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

class Acuerdate41Page extends StatelessWidget {
  @override
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => QueAprendimos41Page()));
                },
                child: Container(
                  width: 50,
                  height: 30,
