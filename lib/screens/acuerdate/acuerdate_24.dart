import 'package:control_de_ansiedad/screens/descubrimientos/que_aprendimos24.dart';
import 'package:control_de_ansiedad/widgets/boton_ejercicio.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

class Acuerdate24Page extends StatelessWidget {
  @override
              ...
              child: PageView(
                ...
                children: [
                  BotonEjercicio(
                      ...
                      texto:
                          'Coloca notas que digan “Un bocado a la vez” en todos los sitios donde comas, o un ícono de una cuchara o un tenedor con la palabra “¡Abajo!”',
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => QueAprendimos24Page()));
                },
                child: Container(
                  width: 50,
                  height: 30,
