import 'package:control_de_ansiedad/screens/descubrimientos/que_aprendimos28.dart';
import 'package:control_de_ansiedad/widgets/boton_ejercicio.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

class Acuerdate28Page extends StatelessWidget {
  @override
              ...
              child: PageView(
                ...
                children: [
                  BotonEjercicio(
                      ...
                      texto:
                          'Coloca la palabra “Agua” o imágenes de gotas de agua. También puedes colocar pequeños tazones con agua en lugares estratégicos.',
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => QueAprendimos28Page()));
                },
                child: Container(
                  width: 50,
                  height: 30,
