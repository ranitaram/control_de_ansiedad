import 'package:control_de_ansiedad/screens/descubrimientos/que_aprendimos5.dart';
import 'package:control_de_ansiedad/widgets/boton_ejercicio.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

class Acuerdate5Page extends StatelessWidget {
  @override
              ...
              child: PageView(
                ...
                children: [
                  BotonEjercicio(
                      ...
                      texto:
                          'Coloca notas en los platos y en la mesa donde comes que diga: “Solamente comer.” También coloca notas sobre objetos que tienden a distraerte mientras comas. Por ejemplo, en el celular, en la computadora o la televisión.',
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => QueAprendimos5Page()));
                },
                child: Container(
                  width: 50,
                  height: 30,
