import 'package:control_de_ansiedad/screens/descubrimientos/que_aprendimos19.dart';
import 'package:control_de_ansiedad/widgets/boton_ejercicio.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

class Acuerdate19Page extends StatelessWidget {
  @override
              ...
              child: PageView(
                ...
                children: [
                  BotonEjercicio(
                      ...
                      texto:
                          'Usa el reloj al revés. Si no utilizas reloj, ponte una cinta o una pulsera elástica en la muñeca o algo que frecuentemente no utilizas.',
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => QueAprendimos19Page()));
                },
                child: Container(
                  width: 50,
                  height: 30,
