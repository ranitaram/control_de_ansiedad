import 'package:control_de_ansiedad/screens/descubrimientos/que_aprendimos33.dart';
import 'package:control_de_ansiedad/widgets/boton_ejercicio.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

class Acuerdate33Page extends StatelessWidget {
  @override
              ...
              child: PageView(
                ...
                children: [
                  BotonEjercicio(
                      ...
                      texto:
                          'Puedes poner pequeños carteles con la imagen de un termómetro, o con las palabras “Calor y Frío”.',
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => QueAprendimos33Page()));
                },
                child: Container(
                  width: 50,
                  height: 30,
